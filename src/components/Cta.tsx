...
export default function Cta() {
  const stats = [
    { value: "200+", label: "Hotels Served", icon: Users },
    { value: "24/7", label: "Service Available", icon: Clock },
    { value: "99.8%", label: "Client Satisfaction", icon: Shield },
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join Paris's leading hotels who trust ParisClean for exceptional housekeeping services. 
                Experience the difference professional hospitality management makes for your guests.
              </p>
              ...
              <div className="text-center mb-12">
                <p className="text-sm text-muted-foreground mb-6">
                  Trusted by luxury hotels across Paris
                </p>
                <div className="flex flex-wrap justify-center items-center gap-8 opacity-60">
                  {/* Hotel logos placeholders */}
                  {[...Array(5)].map((_, i) => (
                    <div 
                      key={i} 
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Complimentary hotel housekeeping evaluation
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Complete coverage and bonded staff protection
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Service implementation within 48 hours
              </p>
            </div>
          </div>
        </div>
